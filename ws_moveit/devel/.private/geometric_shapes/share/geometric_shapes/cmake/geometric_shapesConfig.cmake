...
if("TRUE" STREQUAL "TRUE")
  set(geometric_shapes_SOURCE_PREFIX /home/sandun/ws_moveit/src/geometric_shapes)
  set(geometric_shapes_DEVEL_PREFIX /home/sandun/ws_moveit/devel/.private/geometric_shapes)
  ...
  set(geometric_shapes_INSTALL_PREFIX /home/sandun/ws_moveit/install)
...
if(NOT "/home/sandun/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "/home/sandun/ws_moveit/src/geometric_shapes/include;/usr/include/eigen3;/opt/ros/noetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sandun/ws_moveit/src/geometric_shapes/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sandun/ws_moveit/devel/.private/geometric_shapes/lib;/home/sandun/ws_moveit/devel/lib;/opt/ros/noetic/lib)
